...
export default class HardwareGroupManager extends LightningElement {
    ...
    get groupColumns() {
        return [
            ...
            { label: 'Model', fieldName: 'Hardware__r.Model_Number__c', type: 'text' },
    ...
    get hardwareColumns() {
        return [
            ...
            { label: 'Model', fieldName: 'Model_Number__c', type: 'text' },
    ...
    handleNewHardwareChange(event) {
        ...
        switch(field) {
            ...
            // Legacy fields
            case 'modelNumber':
                this.newHardware.modelNumber = value;
                break;
            case 'status':
    ...
    async handleCreateHardware() {
        try {
            ...
            // Query the newly created hardware to get full details
            const newHardwareRecords = await searchHardware({
                accountId: this.quoteAccountId,
                filters: {}
            });
            ...
            if (createdHardware) {
                this.selectedHardware = createdHardware;
            ...
            this.showToast('Success', 'Hardware created successfully', 'success');
