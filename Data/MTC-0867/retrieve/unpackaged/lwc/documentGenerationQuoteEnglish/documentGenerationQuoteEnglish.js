...
import { OMNIDEF } from './documentGenerationQuoteEnglish_def.js';
import tmpl from './documentGenerationQuoteEnglish.html';
import tmpl_nds from './documentGenerationQuoteEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class documentGenerationQuoteEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
